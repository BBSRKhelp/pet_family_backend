...
namespace PetFamily.Infrastructure.Migrations
{
    ...
    [Migration("20241110140404_INITIAL")]
            ...
            modelBuilder.Entity("PetFamily.Domain.VolunteerAggregate.Entities.Pet", b =>
                {
                    ...
                    b.OwnsOne("PetFamily.Domain.VolunteerAggregate.ValueObjects.Shell.RequisitesShell", "RequisiteShell", b1 =>
                        {
                            b1.Property<Guid>("PetId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("PetFamily.Domain.VolunteerAggregate.ValueObjects.Shell.PetPhotoShell", "PetPhotoShell", b1 =>
                        {
                            b1.Property<Guid>("PetId")
                                .HasColumnType("uuid");
                            ...
                            b1.OwnsMany("PetFamily.Domain.VolunteerAggregate.ValueObjects.PetPhoto", "PetPhotos", b2 =>
                                {
                                    b2.Property<Guid>("PetPhotoShellPetId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("PetPhotoShellPetId", "Id");
                                    ...
                                    b2.WithOwner()
                                        .HasForeignKey("PetPhotoShellPetId")
                                        .HasConstraintName("fk_pets_pets_pet_photo_shell_pet_id");
                                });
                    ...
                    b.Navigation("PetPhotoShell");

                    b.Navigation("PhoneNumber")
                        .IsRequired();

                    b.Navigation("RequisiteShell");
                });
            ...
            modelBuilder.Entity("PetFamily.Domain.VolunteerAggregate.Volunteer", b =>
                {
                    ...
                    b.OwnsOne("PetFamily.Domain.VolunteerAggregate.ValueObjects.Shell.SocialNetworksShell", "SocialNetworksShell", b1 =>
                        {
                            b1.Property<Guid>("VolunteerId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("PetFamily.Domain.VolunteerAggregate.ValueObjects.Shell.RequisitesShell", "RequisitesShell", b1 =>
                        {
                            b1.Property<Guid>("VolunteerId")
                                .HasColumnType("uuid");
                    ...
                    b.Navigation("RequisitesShell");

                    b.Navigation("SocialNetworksShell");
                });
